...
class Ai1ec_Less_Factory {
	...
	/**
	 * The convention states that the class name is Ai1ec_Less_Variable_{$type}.
	 * That class in the constructor must create a $renderable and pass it to 
	 * parent::_contruct()
	 * 
	 * @param string $type
	 * @param array $params
	...
	public static function create_less_variable( $type, array $params ) {
		$type = ucfirst( $type );
		$class = "Ai1ec_Less_Variable_{$type}";
