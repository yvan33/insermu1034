...
class Ai1ec_Helper_Factory {
	 ...
	 * @return Ai1ec_Select
	 */
	public static function create_select_instance( $id, $name = null ) {
		return new Ai1ec_Select( $id, $name );
	}
	...
	/**
	 * @return Ai1ec_Bootstrap_Button
	 */
	public static function create_bootstrap_button_instance() {
		return new Ai1ec_Bootstrap_Button();
	}
}
