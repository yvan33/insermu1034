...
<div class="tab-content ai1ec-boxed-tabs">
	...
	<div class="tab-pane" id="ai1ec-viewing-events">
		...
		<div class="clearfix">
			<label class="textinput" for="week_view_starts_at">
				<?php _e( 'Limit Week/Day view hours between', AI1EC_PLUGIN_NAME ); ?>
			</label>
			<span class="ai1ec-week-view-hours">
				<div class="input-append">
					<input name="week_view_starts_at" id="week_view_starts_at" type="text"
						class="input-mini"
						value="<?php echo esc_attr( $week_view_starts_at ); ?>"
						/><span class="add-on"><?php _e( 'hrs', AI1EC_PLUGIN_NAME ) ?></span>
				</div>
				<?php _e( 'and', AI1EC_PLUGIN_NAME ); ?>
				<div class="input-append">
					<input name="week_view_ends_at" id="week_view_ends_at" type="text"
						class="input-mini"
						value="<?php echo esc_attr( $week_view_ends_at ); ?>"
						/><span class="add-on"><?php _e( 'hrs', AI1EC_PLUGIN_NAME ) ?></span>
				</div>
			</span>
		</div>
	...
	<div class="tab-pane" id="ai1ec-advanced">
		...
		<div class="clearfix">
			<label class="textinput" for="view_cache_refresh_interval"><?php _e( 'Frequency of view cache purging:', AI1EC_PLUGIN_NAME ) ?></label>
			<input name="view_cache_refresh_interval" id="view_cache_refresh_interval" type="text"
				class="input-small"
				value="<?php echo esc_attr( $view_cache_refresh_interval ) ?>" />
			<span class="help-block"><?php _e( 'Calendar view cache will be refreshed at this interval. Enter time in seconds (default behavior), or use suffixes, for example: <strong>10m</strong> = <em>10 minutes</em>; <strong>3h</strong> = <em>3 hours</em>; <strong>1w 3d 12h</strong> = <em>1 week + 3 days + 12 hours</em> = <em>1.5 weeks</em>.', AI1EC_PLUGIN_NAME ) ?></span>
		</div>
