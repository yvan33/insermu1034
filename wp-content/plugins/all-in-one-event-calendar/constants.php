...
function ai1ec_initiate_constants() {
	...
	if ( ! defined( 'AI1EC_VERSION' ) ) {
		define( 'AI1EC_VERSION',            '1.10.11-standard' );
	}
	...
	if ( ! defined( 'AI1EC_THEMES_VERSION' ) ) {
		define( 'AI1EC_THEMES_VERSION',     '28-standard' );
	}
	...
	if ( ! defined( 'AI1EC_CRON_VERSION' ) ) {
		define( 'AI1EC_CRON_VERSION',       110 );
	}
	if ( ! defined( 'AI1EC_N_CRON_VERSION' ) ) {
		define( 'AI1EC_N_CRON_VERSION',     108 );
	}
	...
	if ( ! defined( 'AI1EC_SUPPORTBOX_JS' ) ) {
		define( 'AI1EC_SUPPORTBOX_JS', 'https://api.time.ly/get_support_box.js?version=%s&lang=%s&jquery_timely=true' );
	}
