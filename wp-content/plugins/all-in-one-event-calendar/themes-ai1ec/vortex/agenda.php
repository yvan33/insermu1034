									...
									<div class="ai1ec-event-summary-footer">
										<div class="btn-group ai1ec-actions">
											<?php if ( $is_ticket_button_enabled && ! empty( $event->ticket_url ) ) : ?>
												<a class="btn btn-primary ai1ec-buy-tickets" target="_blank" href='<?php echo $event->ticket_url; ?>'><i class="icon-shopping-cart"></i> <?php _e( 'Buy Tickets', AI1EC_PLUGIN_NAME ); ?></a>
											<?php endif; ?>
