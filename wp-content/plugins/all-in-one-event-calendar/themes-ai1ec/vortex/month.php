									...
									<div class="ai1ec-popup hide">
										...
										<span class="ai1ec-popup-title popover-title">
											...
											<?php if ( $is_ticket_button_enabled && ! empty( $event->ticket_url ) ) : ?>
												<a class="pull-right btn btn-primary btn-mini ai1ec-buy-tickets" target="_blank" href="<?php echo $event->ticket_url; ?>"><i class="icon-shopping-cart"></i> <?php _e( 'Tickets', AI1EC_PLUGIN_NAME ); ?></a>
											<?php endif; ?>
