...
<a href="http://theme4press.com/alora/" target="_blank"><img style="margin-bottom:20px;float:left;position:relative;top:10px;" width="827" height="102" border="0" alt="alora - Multipurpose WordPress Theme" src="<?php echo get_template_directory_uri(); ?>/library/functions/images/alora.jpg"></a>  

<a href="http://wordpress.org/themes/evolve" target="_blank"><img style="margin-bottom:20px;float:left;" width="827" height="66" border="0" alt="evolve on wordpress" src="<?php echo get_template_directory_uri(); ?>/library/functions/images/rate.jpg"></a>
...
<div id="header">
        <div class="logo">
				<h3><img width="100" height="28" src="<?php echo get_template_directory_uri(); ?>/library/functions/images/logo.png" alt="evolve"></h3>
    	...
    	<div id="support-links">
			<ul>
      <li class="home"><a title="Theme Homepage" target="_blank" href="http://www.theme4press.com/<?php echo $evlthemename; ?>/">Theme Homepage</a></li>
    ...
    <ul class="tabNavigation">
        <li class="layout"><a href="#section-evl-tab-1">General Options</a></li>
        <li class="header"><a href="#section-evl-tab-4">Header Options</a></li>        
        <li class="footer"><a href="#section-evl-tab-5">Footer Options</a></li>
        <li class="typography"><a href="#section-evl-tab-6">Typography Options</a></li>
        <li class="styling"><a href="#section-evl-tab-10">Styling Options</a></li>
        <li class="post"><a href="#section-evl-tab-2">Blog Options</a></li>
        <li class="connect"><a href="#section-evl-tab-3">Social Sharing Links</a></li>
        <li class="parallax"><a href="#section-evl-tab-8">Parallax Slider</a></li>
        <li class="posts"><a href="#section-evl-tab-9">Posts Slider</a></li>
        <li class="contact"><a href="#section-evl-tab-13">Contact Options</a></li>
        <li class="nav"><a href="#section-evl-tab-7">Extra Options</a></li>
        <li class="css"><a href="#section-evl-tab-11">Custom CSS</a></li>
        <li class="backup"><a href="#section-evl-tab-12">Backup Options</a></li>
    </ul>
