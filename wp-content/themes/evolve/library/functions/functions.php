...
function evolve_copy() {
  ...
  if (!empty($options['evl_affiliate_id'])) { $ad_affiliate_id = '?ap_id='.$options['evl_affiliate_id']; } else { $ad_affiliate_id = ''; } 
	...
	$credits = '<p id="copyright"><span class="credits"><a href="http://theme4press.com/evolve/'.$ad_affiliate_id.'">evolve</a> theme by Theme4Press&nbsp;&nbsp;&bull;&nbsp;&nbsp;Powered by <a href="http://wordpress.org">WordPress</a></span></p>';
