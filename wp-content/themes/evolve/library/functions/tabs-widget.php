				...
				<div class="tab-box tabs-container">
					...
					<div id="tab-popular" class="tab tab_content" style="display: none;">
						...
						if($orderby == 'Highest Comments') {
							...
							$order_string = '&meta_key=alora_post_views_count&orderby=meta_value_num';
						}
					...
					<div id="tab-comments" class="tab tab_content" style="display: none;">
						<ul class="news-list">
							...
							<li>
								...
								<div class="post-holder">
									<a class="comment-text-side" href="<?php echo get_permalink($comment->ID); ?>#comment-<?php echo $comment->comment_ID; ?>" title="<?php echo strip_tags($comment->comment_author); ?> on <?php echo $comment->post_title; ?>"><?php echo strip_tags($comment->comment_author); ?> <?php _e('says', 'alora'); ?></a>
									<div class="meta">
